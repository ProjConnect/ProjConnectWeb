...
export default function Card({ title, date, image, overview, overviewdescription, requirements, requirementsdescription, othersrequirements, othersrequirementsdescription, comments, commentsdescription }) {
    return (
        <div className="card">
